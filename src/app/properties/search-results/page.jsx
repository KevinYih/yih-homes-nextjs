  ...
  return (
    <>
      ...
      <section className="px-4 py-6">
        <div className="container-xl lg:container m-atuo px-4 py-6"></div>
        <Link href="/properties" className="flex items-center  text-green-500 hover:underline mb-3">
